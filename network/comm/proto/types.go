...
// NotifyCertValRes notify the cert val result to remote peer.
func NotifyCertValRes(ctx context.Context, rpc RPC, str string) error {
	return rpc.Notify(ctx, MsgCertValRes, str)
}

// NotifyNewBlockID notify new block ID to remote peer.
func NotifyNewBlockID(ctx context.Context, rpc RPC, id polo.Bytes32) error {
...
func GetBlockByID(ctx context.Context, rpc RPC, id polo.Bytes32) (rlp.RawValue, error) {
...
func GetBlockIDByNumber(ctx context.Context, rpc RPC, num uint32) (polo.Bytes32, error) {
	var id polo.Bytes32
