...
func TestMissingNode(t *testing.T) {
	...
	// delete "120000"
	db.Delete(common.FromHex("441104088924b2e5c7cad1f84c1489cef750baefc107201334de5aa75f05541a"))
...
func TestInsert(t *testing.T) {
	...
	exp, _ := polo.ParseBytes32("c33dc4124235214a96518fc8bfdef30a6c1462a08e423c29f7b08513829c551f")
	root := trie.Hash()
	if root != exp {
	...
	exp, _ = polo.ParseBytes32("84ec0052caf94dc2df953a1a77ed86c20b401cff8e9b85c1c68511bc3d9259a6")
...
func TestDelete(t *testing.T) {
	...
	hash := trie.Hash()
	exp, _ := polo.ParseBytes32("422a17a872ce2e062b0998b85bee742dfa98f429c49bb22b81495d23fd3ce841")
	if hash != exp {
...
func runRandTest(rt randTest) bool {
	...
	for i, step := range rt {
		...
		case opItercheckhash:
			checktr, _ := New(polo.Bytes32{}, nil)
...
func BenchmarkHash(b *testing.B) {
	...
	trie := newEmpty()
	for i := 0; i < len(addresses); i++ {
		trie.Update(polo.Blake2b(addresses[i][:]).Bytes(), accounts[i])
	}
	b.ResetTimer()
	b.ReportAllocs()
	trie.Hash()
