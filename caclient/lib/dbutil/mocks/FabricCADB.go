...
// PoloChainCADB is an autogenerated mock type for the PoloChainCADB type
type PoloChainCADB struct {
	mock.Mock
}

// BeginTx provides a mock function with given fields:
func (_m *PoloChainCADB) BeginTx() dbutil.PoloChainCATx {
	ret := _m.Called()

	var r0 dbutil.PoloChainCATx
	if rf, ok := ret.Get(0).(func() dbutil.PoloChainCATx); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(dbutil.PoloChainCATx)
		}
	}
...
func (_m *PoloChainCADB) IsInitialized() bool {
	ret := _m.Called()
...
func (_m *PoloChainCADB) MustBegin() *sqlx.Tx {
	ret := _m.Called()
...
func (_m *PoloChainCADB) NamedExec(query string, arg interface{}) (sql.Result, error) {
...
func (_m *PoloChainCADB) Rebind(query string) string {
	ret := _m.Called(query)
...
func (_m *PoloChainCADB) Select(dest interface{}, query string, args ...interface{}) error {
	var _ca []interface{}
