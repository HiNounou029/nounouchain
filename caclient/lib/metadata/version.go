...
// Version specifies polochain-ca-server/polochain-ca-server version
// It is defined by the Makefile and passed in with ldflags
var Version = "1.2.0"

// GetVersionInfo returns version information for the polochain-ca-server/polochain-ca-server
...
func GetVersion() string {
	if Version == "" {
		panic("Version is not set for polochain-ca library")
	}
	return Version
}
