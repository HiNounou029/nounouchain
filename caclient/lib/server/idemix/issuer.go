...
type Issuer interface {
	Init(renew bool, db dbutil.PoloChainCADB, levels *dbutil.Levels) error
...
func (i *issuer) Init(renew bool, db dbutil.PoloChainCADB, levels *dbutil.Levels) error {
...
// DB returns the PoloChainCADB object (which represents database handle
// to the CA database) associated with this issuer
func (i *issuer) DB() dbutil.PoloChainCADB {
	return i.db
}
