...
func (ra *revocationAuthority) getNextRevocationHandleTx(tx dbutil.PoloChainCATx, args ...interface{}) (interface{}, error) {
	var err error
...
func doTransaction(db dbutil.PoloChainCADB, doit func(tx dbutil.PoloChainCATx, args ...interface{}) (interface{}, error), args ...interface{}) (interface{}, error) {
	if db == nil {
