...
func NewCredentialAccessor(db dbutil.PoloChainCADB, level int) CredDBAccessor {
...
func (ac *CredentialAccessor) SetDB(db dbutil.PoloChainCADB) {
	ac.db = db
}
