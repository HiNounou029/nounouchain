...
import (
	...
	ctls "github.com/HiNounou029/nounouchain/caclient/lib/tls"
...
type AttrConfig struct {
	...
	Converters []NameVal            // Used to convert an LDAP entry into a polochain-ca-server attribute
	Maps       map[string][]NameVal // Use to map an LDAP response to polochain-ca-server names
}
