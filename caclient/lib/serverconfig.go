...
import "github.com/HiNounou029/nounouchain/caclient/lib/tls"

const (
	// DefaultServerPort is the default listening port for the polochain-ca server
	DefaultServerPort = 7054

	// DefaultServerAddr is the default listening address for the polochain-ca server
	DefaultServerAddr = "0.0.0.0"
)

// ServerConfig is the polochain-ca server's config
...
type ServerConfig struct {
	...
	Port int `def:"7054" opt:"p" help:"Listening port of polochain-ca-server"`
	// Bind address for the server
	Address string `def:"0.0.0.0" help:"Listening address of polochain-ca-server"`
