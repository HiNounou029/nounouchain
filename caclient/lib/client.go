...
import (
	...
	"github.com/HiNounou029/nounouchain/caclient/lib/client/credential"
	idemixcred "github.com/HiNounou029/nounouchain/caclient/lib/client/credential/idemix"
	x509cred "github.com/HiNounou029/nounouchain/caclient/lib/client/credential/x509"
	"github.com/HiNounou029/nounouchain/caclient/lib/common"
	"github.com/HiNounou029/nounouchain/caclient/lib/streamer"
	"github.com/HiNounou029/nounouchain/caclient/lib/tls"
	"github.com/HiNounou029/nounouchain/caclient/util"
	"github.com/HiNounou029/nounouchain/caclient/bccsp"
	"github.com/HiNounou029/nounouchain/caclient/idemix"	// mod by syl 2018-08-25=========
	"github.com/mitchellh/mapstructure"
)

// Client is the polochain-ca client object
type Client struct {
	...
	csp bccsp.BCCSP
	// HTTP client associated with this PoloChain CA client
...
type GetCAInfoResponse struct {
	...
	CAName string
	// CAChain is the PEM-encoded bytes of the polochain-ca-server's CA chain.
...
func (c *Client) handleX509Enroll(req *api.EnrollmentRequest) (*EnrollmentResponse, error) {
	...
	// Send the CSR to the polochain-ca server with basic auth header
...
// SendReq sends a request to the polochain-ca-server and fills in the result
...
func (c *Client) CheckEnrollment() error {
	...
	return errors.New("Enrollment information does not exist. Please execute enroll command first. Example: polochain-ca-server enroll -u http://user:userpw@serverAddr:serverPort")
}
