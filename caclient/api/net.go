...
import (
	...
	"github.com/HiNounou029/nounouchain/caclient/idemix"
)

/*
 * This file contains the structure definitions for the request
 * and responses which flow over the network between a polochain-ca client
 * and the polochain-ca server.
 */
