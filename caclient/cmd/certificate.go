...
func newListCertificateCommand(c *certificateCommand) *cobra.Command {
	certificateListCmd := &cobra.Command{
		...
		Example: "polochain-ca-server certificate list --id admin --expiration 2018-01-01::2018-01-30\npolochain-ca-server certificate list --id admin --expiration 2018-01-01T01:30:00z::2018-01-30T11:30:00z\npolochain-ca-server certificate list --id admin --expiration -30d::-15d",
