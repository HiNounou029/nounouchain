...
func New(kv kv.GetPutter, genesisBlock *block.Block) (*Chain, error) {
	...
	rawBlocksCache := newCache(blockCacheLimit, func(key interface{}) (interface{}, error) {
		raw, err := loadBlockRaw(kv, key.(polo.Bytes32))
		if err != nil {
			return nil, err
		}
	...
	receiptsCache := newCache(receiptsCacheLimit, func(key interface{}) (interface{}, error) {
		return loadBlockReceipts(kv, key.(polo.Bytes32))
	})
...
func (c *Chain) GetBlockHeader(id polo.Bytes32) (*block.Header, error) {
	c.rw.RLock()
	defer c.rw.RUnlock()
...
func (c *Chain) GetBlockBody(id polo.Bytes32) (*block.Body, error) {
	c.rw.RLock()
	defer c.rw.RUnlock()
...
func (c *Chain) GetBlock(id polo.Bytes32) (*block.Block, error) {
	c.rw.RLock()
	defer c.rw.RUnlock()
...
func (c *Chain) GetBlockRaw(id polo.Bytes32) (block.Raw, error) {
	c.rw.RLock()
	defer c.rw.RUnlock()
...
func (c *Chain) GetBlockReceipts(id polo.Bytes32) (tx.Receipts, error) {
	c.rw.RLock()
	defer c.rw.RUnlock()
...
func (c *Chain) GetAncestorBlockID(descendantID polo.Bytes32, ancestorNum uint32) (polo.Bytes32, error) {
	c.rw.RLock()
	defer c.rw.RUnlock()
...
func (c *Chain) GetTransactionMeta(txID polo.Bytes32, headBlockID polo.Bytes32) (*TxMeta, error) {
	c.rw.RLock()
	defer c.rw.RUnlock()
...
func (c *Chain) GetTransaction(blockID polo.Bytes32, index uint64) (*tx.Transaction, error) {
	c.rw.RLock()
	defer c.rw.RUnlock()
...
func (c *Chain) GetTransactionReceipt(blockID polo.Bytes32, index uint64) (*tx.Receipt, error) {
	c.rw.RLock()
	defer c.rw.RUnlock()
...
func (c *Chain) GetTrunkBlockID(num uint32) (polo.Bytes32, error) {
	c.rw.RLock()
	defer c.rw.RUnlock()
...
func (c *Chain) GetTrunkTransactionMeta(txID polo.Bytes32) (*TxMeta, error) {
	c.rw.RLock()
	defer c.rw.RUnlock()
...
func (c *Chain) GetTrunkTransaction(txID polo.Bytes32) (*tx.Transaction, *TxMeta, error) {
	c.rw.RLock()
	defer c.rw.RUnlock()
...
func (c *Chain) NewSeeker(headBlockID polo.Bytes32) *Seeker {
...
func (c *Chain) getRawBlock(id polo.Bytes32) (*rawBlock, error) {
...
func (c *Chain) getBlockReceipts(blockID polo.Bytes32) (tx.Receipts, error) {
...
func (c *Chain) NewBlockReader(position polo.Bytes32) BlockReader {
...
func (c *Chain) nextBlock(descendantID polo.Bytes32, num uint32) (*block.Block, error) {
